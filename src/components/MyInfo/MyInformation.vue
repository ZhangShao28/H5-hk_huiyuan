    ...
    <div id="MyInformation">
        ...
        <group title="  ">
            ...
            <cell title="出生日期" :link="{path:'/InfoModify',query:{type:2,birth_date:birth_date}}" :value="birth_date"
                  is-link></cell>
            <cell title="詳細住址" :link="{path:'/InfoModify',query:{type:4,address:address}}" :value="address"
                  is-link></cell>
            <cell title="登  記" :value="is_voter" :link="{path:'/InfoModify',query:{type:5,is_voter:is_voter}}"  v-if="cid_type==0"
                  is-link></cell>
