<template>
    <div id="myinfo">
        <div class="top">
            <div class="top_head">
                <flexbox>
                    ...
                    <flexbox-item :span="4" class="text_algin_r" v-if="openCid==1 && show_apply==1">
                        <router-link :to="{path:'/ApplyAdmissionList',query:{acid:openCid}}">
                            <x-button class="apply_btn" mini>入會申請</x-button>
                        </router-link>
                    </flexbox-item>
                    <flexbox-item :span="4" class="text_algin_r" v-else-if="show_apply==1 && openCid!=1">
        ...
        <div v-if="select_id==0">
            ...
            <div class="no_my_xh" v-if="show_apply==1">
      ...
      my_list(){
        ...
        that.api.userMy({
          ...
          .then(function (response) {
            ...
            that.cid = data.cid
            that.show_apply = data.show_apply
            that.u_name = data.u_nickname
            document.title=data.h5_title
            cookie.set('xh_name', data.h5_title, {expires: 30000, path: '/'})
